; Listing generated by Microsoft (R) Optimizing Compiler Version 19.11.25547.0 
	...
	TITLE	D:\8IAR125 - Intelligence artificielle pour le jeu vidéo\ProjetFinal\Projet\armory\Projectile_Slug.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG170266 DB	'Slug_MaxForce', 00H
	ORG $+2
$SG170267 DB	'Slug_Mass', 00H
	ORG $+2
$SG170268 DB	'Slug_MaxSpeed', 00H
	ORG $+2
$SG170269 DB	'Slug_Scale', 00H
	ORG $+1
$SG170270 DB	'Slug_Damage', 00H
$SG170271 DB	'Slug_Persistance', 00H
	ORG $+3
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\8iar125 - intelligence artificielle pour le jeu vidéo\projetfinal\projet\armory\projectile_slug.cpp
_TEXT	SEGMENT
$T1 = -140						; size = 16
$T2 = -124						; size = 16
$T3 = -108						; size = 16
...
; 20   :         Raven_Projectile(target,
	...
	push	OFFSET $SG170266
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG170267
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG170268
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG170269
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG170270
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
...
; Function compile flags: /Odtp /RTCsu
; File d:\8iar125 - intelligence artificielle pour le jeu vidéo\projetfinal\projet\armory\projectile_slug.h
