; Listing generated by Microsoft (R) Optimizing Compiler Version 19.11.25547.0 
	...
	TITLE	D:\8IAR125 - Intelligence artificielle pour le jeu vidéo\ProjetFinal\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG152880 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG152881 DB	'.', 00H, '.', 00H, '\', 00H, 'C', 00H, 'o', 00H, 'm', 00H
	...
	DB	'p', 00H, 00H, 00H
	ORG $+4
$SG152882 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\8iar125 - intelligence artificielle pour le jeu vidéo\projetfinal\common\game\basegameentity.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG152880
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG152881
	push	OFFSET $SG152882
	call	__wassert
