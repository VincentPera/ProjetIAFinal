; Listing generated by Microsoft (R) Optimizing Compiler Version 19.11.25547.0 
	...
	TITLE	D:\8IAR125 - Intelligence artificielle pour le jeu vidéo\ProjetFinal\Common\misc\WindowUtils.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG151365 DB	'Error', 00H
	ORG $+2
$SG151369 DB	'Error', 00H
	ORG $+2
$SG151460 DB	'*.*', 00H
$SG151461 DB	'All Files (*.*)', 00H
$SG151462 DB	'*.', 00H
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\program files (x86)\microsoft visual studio\2017\community\vc\tools\msvc\14.11.25503\include\iomanip
...
; 540  : 	{	// insert by calling function with output stream and argument
...
; 541  : 	(*_Manip._Pfun)(_Ostr, _Manip._Manarg);
...
; 3840 : 	return (_STD move(_Left.append(_Right)));
...
; 3816 : 	basic_string<_Elem, _Traits, _Alloc> _Ans;

	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0

; 3817 : 	_Ans.reserve(_Left.size() + 1);
...
; Function compile flags: /Odtp /RTCsu
; File d:\8iar125 - intelligence artificielle pour le jeu vidéo\projetfinal\common\misc\stream_utility_functions.h
...
; Function compile flags: /Odtp /RTCsu
; File d:\8iar125 - intelligence artificielle pour le jeu vidéo\projetfinal\common\misc\windowutils.cpp
_TEXT	SEGMENT
$T1 = -42						; size = 1
$T2 = -41						; size = 1
_s$ = -36						; size = 28
...
; 109  :                        "All Files (*.*)" + '\0' + "*.*" + '\0' + '\0';
	...
	push	0
	push	OFFSET $SG151461
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG151462
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
...
; 3056 : 		{	// return length of sequence
...
; 3057 : 		return (this->_Get_data()._Mysize);
...
; 2953 : 		{	// subscript mutable sequence with checking
...
; 2954 : 		auto& _My_data = this->_Get_data();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Get_data@?$_String_alloc@U?$_String_base_types@DV?$allocator@D@std@@@std@@@std@@QAEAAV?$_String_val@U?$_Simple_types@D@std@@@2@XZ ; std::_String_alloc<std::_String_base_types<char,std::allocator<char> > >::_Get_data
	mov	DWORD PTR __My_data$[ebp], eax

; 2955 : 		_My_data._Check_offset_exclusive(_Off);
...
; 2956 : 		return (_My_data._Myptr()[_Off]);
...
; 1629 : 		{	// checks whether _Off is in the bounds of [0, this->size())
